...
g++ -I include -c src/backend/tensor_cpu.cpp -o build/tensor_cpu.o
...
g++ -I include main.cpp build/cpu.o build/tensor.o build/tensor_iterator.o build/autograd.o build/ops.o build/models.o build/optimizers.o -o build/main
