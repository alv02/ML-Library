...
// Replicates max_pool2d forward exactly
...
int main(int argc, char **argv) {
    ...
    printf("\n-- tensor_unfold2d --\n");
    test_unfold2d("1x1x4x4  k=3 s=1 p=0", "unfold2d_1c_4x4_k3s1",    Unfold2dParams(3));
    test_unfold2d("1x2x3x3  k=2 s=1 p=0", "unfold2d_2c_3x3_k2s1",    Unfold2dParams(2));
    test_unfold2d("2x1x4x4  k=3 s=1 p=0", "unfold2d_batch_4x4_k3s1", Unfold2dParams(3));
    test_unfold2d("1x1x6x6  k=3 s=2 p=0", "unfold2d_1c_6x6_k3s2",    Unfold2dParams(3, 2, 0));
    test_unfold2d("1x1x5x5  k=2 s=2 p=0", "unfold2d_1c_5x5_k2s2",    Unfold2dParams(2, 2, 0));
    test_unfold2d("1x1x3x3  k=3 s=1 p=1", "unfold2d_1c_3x3_k3p1",    Unfold2dParams(3, 1, 1));
    test_unfold2d("1x1x4x4  k=3 s=1 p=1", "unfold2d_1c_4x4_k3p1",    Unfold2dParams(3, 1, 1));
    test_unfold2d("1x1x4x4  k=3 s=2 p=1", "unfold2d_1c_4x4_k3s2p1",  Unfold2dParams(3, 2, 1));

    printf("\n-- tensor_unfold2d (non-contiguous input) --\n");
    test_unfold2d_noncontig("1x2x3x3  k=2 s=1 p=0", "unfold2d_noncontig_2c_3x3_k2s1",    Unfold2dParams(2));
    test_unfold2d_noncontig("2x1x4x4  k=3 s=1 p=0", "unfold2d_noncontig_batch_4x4_k3s1", Unfold2dParams(3));
    test_unfold2d_noncontig("2x3x4x4  k=3 s=1 p=0", "unfold2d_noncontig_2n3c_4x4_k3s1",  Unfold2dParams(3));
    test_unfold2d_noncontig("2x3x4x4  k=3 s=1 p=1", "unfold2d_noncontig_2n3c_4x4_k3p1",  Unfold2dParams(3, 1, 1));

    printf("\n-- tensor_fold2d --\n");
    test_fold2d("1x1x4x4  k=3 s=1 p=0", "fold2d_1c_4x4_k3s1",    Unfold2dParams(3),       1, 1, 4, 4);
    test_fold2d("1x2x3x3  k=2 s=1 p=0", "fold2d_2c_3x3_k2s1",    Unfold2dParams(2),       1, 2, 3, 3);
    test_fold2d("2x1x4x4  k=3 s=1 p=0", "fold2d_batch_4x4_k3s1", Unfold2dParams(3),       2, 1, 4, 4);
    test_fold2d("1x1x6x6  k=3 s=2 p=0", "fold2d_1c_6x6_k3s2",    Unfold2dParams(3, 2, 0), 1, 1, 6, 6);
    test_fold2d("1x1x4x4  k=3 s=1 p=1", "fold2d_1c_4x4_k3p1",    Unfold2dParams(3, 1, 1), 1, 1, 4, 4);
    test_fold2d("1x1x4x4  k=3 s=2 p=1", "fold2d_1c_4x4_k3s2p1",  Unfold2dParams(3, 2, 1), 1, 1, 4, 4);
    test_fold2d("2x3x4x4  k=3 s=1 p=0", "fold2d_2n3c_4x4_k3s1",  Unfold2dParams(3),       2, 3, 4, 4);
